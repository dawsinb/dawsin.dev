...
const ResearchContent = (
  <div>
    ...
    . My focus has since shifted towards design, but I am still very interested in the usage of machine learning,
    particularly for artistic pursuits.
    <br />
    <br />

...
const ResearchContent = (
  <div>
    ...
    still very interested in the usage of AI, and continue to work with it in my career.
    <br />
    <br />
...
const ResearchContentJp = (
  <div>
    大学時代、<em>機械学習</em>
    の研究に取り組みました。もはや私の主な焦点ではありませんが、私はまだAIの使用に非常に興味を持っており、自分のキャリアでAIに取り組み続けています。
    <br />
    <br />
